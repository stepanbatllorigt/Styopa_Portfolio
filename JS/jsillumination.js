...
var paginaIllumination = document.getElementById("illumination_window");
function inicializado(){   
cargador.className="nomeves";
paginaIllumination.className="meves"; 
}
...
function changeImage(){ 
    ...
    var stringURL = "../MEDIA/IMAGES/Illumination/imagenes/" + a + ".png";
